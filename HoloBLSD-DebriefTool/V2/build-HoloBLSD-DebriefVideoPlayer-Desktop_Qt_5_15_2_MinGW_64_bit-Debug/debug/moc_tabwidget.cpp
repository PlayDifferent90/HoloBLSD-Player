...
#include <memory>
#include "../../HoloBLSD-DebriefVideoPlayer/tabwidget.h"
...
QT_MOC_LITERAL(1, 10, 20), // "ZoomVideoCoordinator"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 8) // "videoPos"

    },
    "TabWidget\0ZoomVideoCoordinator\0\0"
    "videoPos"
};
...
void TabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ZoomVideoCoordinator((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TabWidget::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabWidget::ZoomVideoCoordinator)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TabWidget::ZoomVideoCoordinator(float _t1)
{
