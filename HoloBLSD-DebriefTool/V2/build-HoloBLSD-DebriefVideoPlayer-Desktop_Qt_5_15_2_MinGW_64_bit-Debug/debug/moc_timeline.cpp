...
#include <memory>
#include "../../HoloBLSD-DebriefVideoPlayer/timeline.h"
...
QT_MOC_LITERAL(1, 9, 13), // "TimelineDrawn"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 13), // "AddedActivity"
QT_MOC_LITERAL(4, 38, 4), // "name"
QT_MOC_LITERAL(5, 43, 10), // "visibility"
QT_MOC_LITERAL(6, 54, 17) // "FlushedActivities"

    },
    "Timeline\0TimelineDrawn\0\0AddedActivity\0"
    "name\0visibility\0FlushedActivities"
};
...
void Timeline::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->TimelineDrawn(); break;
        case 1: _t->AddedActivity((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 2: _t->FlushedActivities(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Timeline::TimelineDrawn)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Timeline::*)(QString , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Timeline::AddedActivity)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Timeline::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Timeline::FlushedActivities)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Timeline::TimelineDrawn()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Timeline::AddedActivity(QString _t1, bool _t2)
{
...
// SIGNAL 2
void Timeline::FlushedActivities()
{
