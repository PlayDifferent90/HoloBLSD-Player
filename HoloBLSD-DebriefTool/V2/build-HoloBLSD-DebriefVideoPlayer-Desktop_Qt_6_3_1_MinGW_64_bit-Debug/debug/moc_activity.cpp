...
#include <memory>
#include "../../HoloBLSD-DebriefVideoPlayer/activity.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Activity_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Activity_t qt_meta_stringdata_Activity = {
    {
QT_MOC_LITERAL(0, 8) // "Activity"
...
const QMetaObject Activity::staticMetaObject = { {
    ...
    qt_meta_stringdata_Activity.offsetsAndSize,
    qt_meta_data_Activity,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Activity_t
